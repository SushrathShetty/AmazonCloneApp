...
import com.example.amazoncloneapp.IntroActivity;
import com.example.amazoncloneapp.R;
import com.example.amazoncloneapp.ShowHistory;
import com.example.amazoncloneapp.model.Users;
        ...
        profileHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (setImageUri != null) {
                    ...
                    String imgUri = "https://firebasestorage.googleapis.com/v0/b/cloneapp-7eddb.appspot.com/o/profileimg.png?alt=media&token=eb0b6fa6-ba02-43c5-ae26-cb857a47eb2d";
